...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* Sidebar - KEY CHANGES HERE */}
      <div
        className={`fixed left-0 top-0 h-screen w-72 bg-gradient-to-b from-white to-gray-50 shadow-2xl border-r border-gray-100 transform transition-all duration-300 ease-out z-50 lg:relative lg:translate-x-0 flex flex-col ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* Header with gradient background */}
        <div className="relative p-6 bg-gradient-to-r from-green-600 to-green-700 text-white flex-shrink-0">
        ...
        {/* Navigation Menu - KEY CHANGES HERE */}
