    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
                ...
                <p className="text-blue-100">Manage all registered users and their activities</p>
            </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-gray-200">
                                ...
                                <th className="text-left py-3 px-4 font-medium text-gray-600">Statistics</th>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="space-y-2 text-sm">
                                        <p><span className="text-gray-600">Name:</span> {selectedUser.fullName}</p>
                                        <p><span className="text-gray-600">Email:</span> {selectedUser.email}</p>
                                        <p><span className="text-gray-600">Phone:</span> {selectedUser.phone || 'N/A'}</p>
                                        <p><span className="text-gray-600">Address:</span> {selectedUser.address || 'N/A'}</p>
                                        <p><span className="text-gray-600">City:</span> {selectedUser.city || 'N/A'}</p>
                                    </div>
                                </div>
                                <div>
                                    <h4 className="font-medium text-gray-900 mb-3">Activity Statistics</h4>
                                    <div className="space-y-2 text-sm">
                                        <p><span className="text-gray-600">Total Requests:</span> {selectedUser.totalRequests}</p>
                                        <p><span className="text-gray-600">Completed:</span> {selectedUser.completedRequests}</p>
                                        <p><span className="text-gray-600">Total Value:</span> Rs. {selectedUser.totalValue.toFixed(2)}</p>
                                        <p><span className="text-gray-600">Last Activity:</span> {formatDate(selectedUser.lastActivity)}</p>
